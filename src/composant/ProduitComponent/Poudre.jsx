...
import pate from "../../data/poudre.js";
...
import SachetOceanSaveur from "./SachetOceanSaveur.jsx";
import CubeMarinMix5g from "./CubeMarinMix5g.jsx";
import CubeMarinMix10g from "./CubeMarinMix10g.jsx";
    ...
    <div className="bg-white px-8 md:px-[5rem] pt-[8rem] relative">
      <div className="relative z-20">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <h1 className="text-maron font-bold text-[2em]">Produits en Poudre</h1>
        </div>
      ...
      <div className="grid md:grid-cols-12 w-full relative z-20 md:gap-0">
        <div className="col-span-4 px-4">
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-maraB font-bold my-2">Types des Produits en Poudres</p>
          ...
          {idPro === 1 ? (
            <div className="flex items-center -mt-1 ">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-maintso text-[20px]">Sachet</h1>
              </div>
            ...
            <div className="flex items-center -mt-1 ">
              <div className="flex items-center space-x-2">
                <Star size={10} className="text-maintso" />
                <h1 className="text-maintso text-[20px]">Cube</h1>
              </div>
