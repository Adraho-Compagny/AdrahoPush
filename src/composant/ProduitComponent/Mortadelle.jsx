...
import mortadelle from "../../data/mortadelle.js";
import ModalProduit from "./ModalProduit.jsx";
import MMBoyauMort from "./MMBoyauMort.jsx";
import GMBoyauMort from "./GMBoyauMort.jsx";
...
const Mortadelle = () => {
  ...
  useEffect(() => {
    const product = mortadelle[activeIndex];
    setNom(product.name);
    ...
    <div className="bg-white px-8 md:px-[5rem] pt-[8rem] relative">
      <div className="relative z-20">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
          <h1 className="text-maron font-bold text-[2em]">Mortadelles</h1>
        </div>
      ...
      <div className="grid md:grid-cols-12 w-full relative z-20 md:gap-0">
        <div className="col-span-4 px-2">
          ...
          <div>
            ...
            <div className="mt-4">
              <p className="text-maraB font-bold my-2">Types des Mortadelles</p>

              <div className=" md:px-12 mx-auto max-w-[80vw] md:max-w-[90vw]">
                <Slider
                  ref={sliderRef}
                  {...settings}
                  afterChange={handleSliderChange}
                >
                  {mortadelle.map((product, index) => (
        ...
        <div className="col-span-5 md:px-10 py-2">
          <img
            ...
            className="rounded-md h-[19rem] w-[95%] md:w-full object-cover imagePrincipal cursor-pointer"
          />
        </div>
